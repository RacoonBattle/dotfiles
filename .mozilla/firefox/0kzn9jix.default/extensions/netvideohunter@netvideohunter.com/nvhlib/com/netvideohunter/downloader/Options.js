...
var Options=function (window){
	...
	this.updateDownloadFilePicker=function(){
		...
		var currentDir = window.document.getElementById("extensions.netvideohunter.download.customDir").value;
		if(!currentDir) currentDir=window.document.getElementById("extensions.netvideohunter.download.customDir").value=getDefaultDownloadsFolder();
